...
import classes from './BlogHistory.css'
...
// import { LoadingHistoryComponent } from 'src/views/emptyBlogs/EmptyBlog';
...
const BlogHistory = () => {
  return (
    <> 
    <h1> Blog History is loading...</h1>
    <div className='container'> 
        <h1> Card1</h1>
        <span> The Food Blog Campaign</span>
    </div>
    <br/>
    <div className='container'> 
        <h1> Card2</h1>
